"""
Django settings for nba_shotcharts project.
...
SECRET_KEY = os.environ.get('NBA_SC_KEY')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

ALLOWED_HOSTS = [
    'nbashotcharts.wilsonmacleod.com',
    'localhost'
]
...
ROOT_URLCONF = 'nba_shotcharts.urls'
...
WSGI_APPLICATION = 'nba_shotcharts.wsgi.application'
